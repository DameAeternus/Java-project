...
public class IzborPredmet {
    ...
    public static void main(String[] args) {
        ...
        try {
            Graph<String> graf = new Graph(n, text);
            int m = in.nextInt();
            in.nextLine();
            for (int i=0; i < m; ++i) {
                ...
                graf.addEdge(mapa.get(node1), mapa.get(node));
            }
            String toSearch = in.nextLine();
            LinkedList<GraphNode<String>> lista = graf.adjList[mapa.get(toSearch)].getNeighbors();
